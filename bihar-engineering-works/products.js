const productCatalog = [
    {
        categoryName: "Refractory Equipments",
        products: [
            {
                ...
                link: "electric-servo-press.html",
            },
            {
    ...
    {
        categoryName: "Mixing Equipments",
        products: [
            {
                name: "Counter Current Intensive Mixer Machine",
                image: "https://ik.imagekit.io/4erfuvr85e/BEW/Latest%20Products/ccim-1752602368-8203941.jpeg",
                link: "counter-current-mixer.html",
            },
            {
            ...
            },
            {
                ...
                link: "ribbon-blender-mixer.html",
            },
        ],
    },
    {
        categoryName: "Material Handling Equipments",
        products: [
            {
                ...
                link: "belt-conveyor-system.html",
            },
            {
                ...
                link: "steep-angle-conveyor.html",
            },
            {
            ...
            },
            {
                ...
                link: "roller-conveyor.html",
            },
        ],
    },
    {
        categoryName: "Special Purpose Machines",
        products: [
            {
                ...
                link: "electric-winch-machine.html",
            },
            {
                ...
                link: "sheet-bending-machine.html",
            },
        ],
    },
    {
        ...
        products: [
            ...
            },
            {
                ...
                link: "skid-mounted-crushing-plant.html",
            },
        ],
    },
];

// 2. The Light Mode Render Function
    document.addEventListener('DOMContentLoaded', () => {
        ...
        productCatalog.forEach(category => {
            ...
            // Premium Category Header (Black text, orange accent block)
            finalHTML += `
                <section>
